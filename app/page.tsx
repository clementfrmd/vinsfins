  ...
  return (
    <>
      ...
      <section className="px-4 sm:px-8 lg:px-20 py-16 sm:py-24 lg:py-40">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12 sm:mb-20">
            ...
            <Link href="/wines" className="text-[10px] tracking-luxury uppercase text-charcoal/30 hover:text-charcoal transition-colors duration-500">{t("home.viewCollection")}</Link>
          </div>
      ...
      <section className="py-24 sm:py-32 text-center px-4">
        ...
        <p className="text-xs text-charcoal/35 mb-8 max-w-sm mx-auto font-light leading-relaxed">{t("home.ctaDesc")}</p>
        <Link href="/contact#reservation" className="text-[11px] tracking-luxury uppercase text-charcoal/40 hover:text-charcoal border-b border-charcoal/15 pb-1 transition-colors duration-500">{t("home.ctaButton")}</Link>
      </section>
    </>
  );
}
