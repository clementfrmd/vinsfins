    ...
    <div>
      <section className="relative h-[60vh] sm:h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-cream px-4 sm:px-6">
          <p className="uppercase tracking-luxury text-gold/70 text-[11px] mb-4 sm:mb-6">{t("menuPage.heroLabel")}</p>
          <h1 className="font-playfair text-3xl sm:text-5xl lg:text-7xl font-normal">{t("menuPage.heroTitle")}</h1>
        </div>
      </section>
        ...
        <div className="container-custom mx-auto max-w-3xl">
          <div className="mb-16 sm:mb-28 border border-charcoal/5 p-6 sm:p-10 lg:p-16">
            <div className="text-center mb-8 sm:mb-12">
              <p className="text-[11px] uppercase tracking-luxury text-sage mb-4">{t("menuPage.limitedEdition")}</p>
                    ...
                    <div className="flex justify-between items-start gap-4 sm:gap-6">
                      <div className="flex-1">
                        <div className="flex items-center gap-3">
                          ...
                          {item.isSpecial && <span className="text-[10px] tracking-luxury uppercase text-sage">{t("menuPage.special")}</span>}
                        </div>
                        <p className="text-sm text-charcoal/40 mt-1 sm:mt-2 font-light leading-relaxed">{item.description}</p>
                        {item.winePairing && <p className="text-xs text-burgundy/50 mt-2 sm:mt-3 font-light italic">{t("menuPage.pairWith")} {item.winePairing}</p>}
                      </div>
          ...
          <div className="text-center py-8 sm:py-12 border-t border-charcoal/5">
            <p className="text-charcoal/30 text-xs font-light leading-relaxed tracking-wide">{t("menuPage.menuNote")}</p>
          </div>
        </div>
      </section>
    </div>
