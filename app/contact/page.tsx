    ...
    <div>
      <section className="relative h-[60vh] sm:h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-cream px-4 sm:px-6">
          <p className="uppercase tracking-luxury text-gold/70 text-[11px] mb-4 sm:mb-6">{t("contact.heroLabel")}</p>
          <h1 className="font-playfair text-3xl sm:text-5xl lg:text-7xl font-normal">{t("contact.heroTitle")}</h1>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-custom mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20">
            <div>
              <h2 className="font-playfair text-2xl sm:text-3xl lg:text-4xl mb-8 sm:mb-12">{t("contact.findUs")}</h2>
              <div className="space-y-8 sm:space-y-10 mb-10 sm:mb-14">
                <div>
                  <p className="text-[11px] uppercase tracking-luxury text-gold/70 mb-3">{t("contact.addressLabel")}</p>
                  <p className="text-charcoal/50 font-light leading-relaxed">18 Rue Münster<br />L-2160 Grund, Luxembourg</p>
                </div>
                <div>
                  <p className="text-[11px] uppercase tracking-luxury text-gold/70 mb-3">{t("contact.phoneLabel")}</p>
                ...
                <div>
                  <p className="text-[11px] uppercase tracking-luxury text-gold/70 mb-3">{t("contact.emailLabel")}</p>
                ...
                <div>
                  <p className="text-[11px] uppercase tracking-luxury text-gold/70 mb-3">{t("contact.hoursLabel")}</p>
                ...
                <div>
                  <p className="text-[11px] uppercase tracking-luxury text-gold/70 mb-3">{t("contact.gettingHere")}</p>
                  <p className="text-charcoal/50 text-sm font-light leading-[1.9]">{t("contact.gettingHereText")}</p>
                </div>
              </div>
            ...
            <div className="space-y-8 sm:space-y-10">
              <div className="aspect-video w-[calc(100%+2rem)] -ml-4 sm:w-full sm:ml-0 overflow-hidden">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2585.8!2d6.131!3d49.6096!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDnCsDM2JzM0LjYiTiA2wrAwNyc1MS42IkU!5e0!3m2!1sen!2slu!4v1234567890" width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Vins Fins Location" className="sm:rounded-sm" />
              </div>

              <div id="reservation" className="border border-charcoal/5 p-6 sm:p-10 lg:p-14">
                <h2 className="font-playfair text-xl sm:text-2xl lg:text-3xl mb-3 sm:mb-4">{t("contact.reserveTitle")}</h2>
                <p className="text-charcoal/40 text-sm mb-6 sm:mb-8 font-light leading-relaxed">{t("contact.reserveDesc")}</p>
                <div className="border border-charcoal/5 p-6 sm:p-10 text-center bg-cream/50 mb-6 sm:mb-8">
                  <p className="font-playfair text-lg mb-2 text-charcoal/60">{t("contact.zenchefTitle")}</p>
                  <p className="text-charcoal/30 text-xs mb-4 font-light">{t("contact.zenchefId")}</p>
                  <p className="text-[11px] text-charcoal/25 font-light">{t("contact.zenchefNote")}</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-xs text-charcoal/30 mt-4 font-light">{t("contact.orCallUs")} <a href="tel:+352123456" className="text-burgundy hover:opacity-60 transition-opacity duration-500">+352 12 34 56</a></p>
                </div>
              </div>
            </div>
          </div>
