    ...
    <div>
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-cream px-6">
          <p className="uppercase tracking-luxury text-gold/70 text-[11px] mb-6">Nous Contacter</p>
          <h1 className="font-playfair text-5xl sm:text-6xl lg:text-7xl font-normal">Contact</h1>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-custom mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            {/* Contact Info */}
            <div>
              <h2 className="font-playfair text-3xl sm:text-4xl mb-12">Find Us</h2>
              ...
              <div className="flex gap-6">
                <a href="https://instagram.com/vins_fins_grund" target="_blank" rel="noopener noreferrer" className="text-charcoal/30 hover:text-charcoal transition-colors duration-500">
                ...
                <a href="https://facebook.com/vins.fins.winebar" target="_blank" rel="noopener noreferrer" className="text-charcoal/30 hover:text-charcoal transition-colors duration-500">
            ...
            <div className="space-y-10">
              ...
              {/* Reservation */}
              <div id="reservation" className="border border-charcoal/5 p-10 sm:p-14">
                <h2 className="font-playfair text-2xl sm:text-3xl mb-4">Réserver une Table</h2>
                <p className="text-charcoal/40 text-sm mb-8 font-light leading-relaxed">
                  Book online via our reservation system or call us directly.
                </p>

                <div className="border border-charcoal/5 p-10 text-center bg-cream/50 mb-8">
