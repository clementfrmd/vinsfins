...
export default function Footer() {
  ...
  return (
    <footer className="bg-charcoal text-cream/50">
      <div className="mx-auto px-8 sm:px-12 lg:px-20 py-24 sm:py-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-[11px] uppercase tracking-luxury text-cream/30 mb-8">Explore</h4>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-[11px] uppercase tracking-luxury text-cream/30 mb-8">Visit</h4>
            <ul className="space-y-4 text-sm font-light">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-[11px] uppercase tracking-luxury text-cream/30 mb-8">Newsletter</h4>
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="space-y-4">
                <input
                  ...
                  required
                  className="w-full bg-transparent border-b border-cream/15 px-0 py-3 text-sm text-cream placeholder:text-cream/20 focus:outline-none focus:border-gold/50 transition-colors duration-500"
                />
                <button type="submit" className="text-[11px] uppercase tracking-luxury text-cream/40 hover:text-cream border-b border-cream/15 pb-1 transition-colors duration-500">
                  Subscribe
                </button>
              </form>
            )}
        ...
        {/* Social + Bottom */}
        <div className="border-t border-cream/8 pt-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex gap-6">
            <a href="https://instagram.com/vins_fins_grund" target="_blank" rel="noopener noreferrer" className="hover:text-cream transition-colors duration-500" aria-label="Instagram">
            ...
            <a href="https://facebook.com/vins.fins.winebar" target="_blank" rel="noopener noreferrer" className="hover:text-cream transition-colors duration-500" aria-label="Facebook">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://www.tripadvisor.com/Restaurant_Review-Luxembourg" target="_blank" rel="noopener noreferrer" className="hover:text-cream transition-colors duration-500" aria-label="TripAdvisor">
